            ...
            >
              ...
              >
                <p className="env-invite-text">
                  We're getting married and we'd love
                  <br />
          ...
          >
            ...
            >
              ...
              <motion.h1
                ...
                transition={{ duration: 1, delay: 0.9 }}
              >
                <span className="inv-name"><span>Abdelrahman</span><span>Eltoukhy</span></span>
                <span className="inv-amp">&</span>
                <span className="inv-name"><span>Reem</span><span>Elshaarawy</span></span>
              </motion.h1>
